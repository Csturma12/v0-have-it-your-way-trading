        ...
        <div className="flex items-center gap-2">
          ...
          <Badge 
            ...
            className={`text-[10px] px-1.5 py-0 ${
              source === 'tradier' ? 'border-green-500/50 text-green-400' :
              source === 'polygon' ? 'border-blue-500/50 text-blue-400' :
              source === 'uw' ? 'border-purple-500/50 text-purple-400' :
              source === 'finnhub' ? 'border-cyan-500/50 text-cyan-400' :
